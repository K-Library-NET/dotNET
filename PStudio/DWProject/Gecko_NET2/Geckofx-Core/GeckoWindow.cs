        ...
        : IDisposable
    {
        ...
        public WindowUtils WindowUtils
        {
            get
            {
                ...
                return ExtensionMethods.Wrap(utils, WindowUtils.Create);
        ...
        public GeckoDomDocument Document
        {
            get
            {
                return ExtensionMethods.Wrap(_domWindow.Instance.GetDocumentAttribute(), GeckoDomDocument.CreateDomDocumentWraper);
                //return _domWindow.Instance.GetDocumentAttribute().Wrap(GeckoDomDocument.CreateDomDocumentWraper);
            }
        }
        ...
        public GeckoWindow Parent
        {
            get
            {
                return ExtensionMethods.Wrap(_domWindow.Instance.GetParentAttribute(), Create);
                //return _domWindow.Instance.GetParentAttribute().Wrap(Create);
            }
        }
        ...
        public GeckoWindow Top
        {
            get
            {
                return ExtensionMethods.Wrap(_domWindow.Instance.GetTopAttribute(), Create);
                //return _domWindow.Instance.GetTopAttribute().Wrap(Create);
            }
        }
