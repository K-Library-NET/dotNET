...
namespace Gecko
{
		...
		nsISupportsWeakReference
	{
		...
		//callbacks
        private BaseTypes.Action<nsIWebProgress, nsIRequest, uint, int> _onStateChangeCallback;
        ...
        internal BaseTypes.Action<nsIWebProgress, nsIRequest, uint, int> OnStateChangeCallback
		{
