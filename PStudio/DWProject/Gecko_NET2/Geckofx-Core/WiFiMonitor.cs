...
namespace Gecko
{
	...
	{
		private ComPtr<nsIWifiAccessPoint> _wifiAccessPoint;

		public WifiAccessPoint(nsIWifiAccessPoint wifiAccessPoint)
		{
			_wifiAccessPoint = new ComPtr<nsIWifiAccessPoint>( wifiAccessPoint );
		}


		public string Mac
		{
			get { return nsString.Get( _wifiAccessPoint.Instance.GetMacAttribute ); }
		}

		public string Ssid
		{
			get { return nsString.Get(_wifiAccessPoint.Instance.GetSsidAttribute); }
		}
	}
}