...
namespace Gecko
{
	...
	public static class nsString
	{
		...
		private static void GenericSet<TString>(BaseTypes.Action<TString> setter, string value)
        ...
        private static void GenericSet<T, TString>(BaseTypes.Action<T, TString> setter, T value, string stringValue)
			where TString : IString, IDisposable, new()
		{
        ...
        private static void GenericSet<TString>(BaseTypes.Action<TString, TString> setter, string value1, string value2)
			where TString : IString, IDisposable, new()
		{
        ...
        private static void GenericSet<TString>(BaseTypes.Action<TString, TString, TString> setter, string value1, string value2, string value3)
			where TString : IString, IDisposable, new()
		{
        ...
        private static void GenericSet<T1, T2, TString>(BaseTypes.Action<T1, T2, TString> func, T1 value1, T2 value2, string stringValue)
			where TString : IString, IDisposable, new()
		{
			using (var native = new TString())
			{
        ...
        private static void GenericSet<T1, TString, T2>(BaseTypes.Action<T1, TString, T2> func, T1 value1, string stringValue, T2 value2)
			where TString : IString, IDisposable, new()
		{
			using (var native = new TString())
			{
		...
		/// <returns></returns>
		private static string GenericGet<TString>(BaseTypes.Action<TString> getter)
			where TString : IString, IDisposable, new()
		{
			string ret;
			using (var str = new TString())
		...
		/// <returns></returns>
		private static string GenericGet<TString>(BaseTypes.Action<TString, TString> getter, string inValue)
			where TString : IString, IDisposable, new()
		{
			string ret;
		...
		/// <returns></returns>
		private static string GenericGet<T, TString>(BaseTypes.Action<T, TString> func, T value)
			where TString : IString, IDisposable, new()
		{
			string ret;
		...
		/// <returns></returns>
		private static string GenericGet<T1,T2, TString>(BaseTypes.Action<T1, T2, TString> func, T1 value1, T2 value2)
			where TString : IString, IDisposable, new()
		{
			string ret;
			using (var native = new TString())
		...
		/// <param name="value"></param>
		/// <returns></returns>
		private static T GenericPass<T, TString>(BaseTypes.Func<TString, T> func, string value)
			where TString : IString, IDisposable, new()
		{
			T ret;
			using (var str = new TString())
		...
		/// <returns></returns>
		private static T2 GenericPass<T1, TString, T2>(BaseTypes.Func<T1, TString, T2> func, T1 value, string stringValue)
			where TString : IString, IDisposable, new()
		{
			T2 ret;
			using (TString native = new TString())
		...
		private static T2 GenericPass<TString, T1, T2>(BaseTypes.Func<TString, T1, T2> func, string stringValue, T1 value)
			where TString : IString, IDisposable, new()
		{
			T2 ret;
			using (TString native = new TString())
		...
		/// <param name="value2"></param>
		/// <returns></returns>
		private static T GenericPass<T, TString>(BaseTypes.Func<TString, TString, T> func, string value1, string value2)
			where TString : IString, IDisposable, new()
		{
			T ret;
		...
		public static string Get(BaseTypes.Action<nsAUTF8String> getter)
		{
			return GenericGet( getter );
		}

		public static string Get(BaseTypes.Action<nsAUTF8String, nsAUTF8String> getter, string inValue)
		{
		...
		/// <param name="value"></param>
		public static void Set(BaseTypes.Action<nsAUTF8String> setter, string value)
		{
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public static T Pass<T>(BaseTypes.Func<nsAUTF8String, T> func, string value)
		{
			return GenericPass( func, value );
		}

		public static T Pass<T,TW> (BaseTypes.Func<TW,nsAUTF8String,T> func,TW value,string stringValue )
		{
			return GenericPass( func, value, stringValue );
		}

		public static T Pass<T, TW>(BaseTypes.Func<nsAUTF8String, TW, T> func,  string stringValue,TW value)
		{
		...
		public static string Get(BaseTypes.Action<nsACString> getter)
		{
			return GenericGet( getter );
		}

		public static string Get(BaseTypes.Action<nsACString,nsACString> getter,string inValue)
		{
			return GenericGet( getter, inValue );
		}

		public static string Get<T>(BaseTypes.Action<T, nsACString> func, T value)
		{
		...
		/// <param name="setter"></param>
		/// <param name="value"></param>
		public static void Set(BaseTypes.Action<nsACString> setter, string value)
		{
			GenericSet( setter, value );
		}

		public static void Set(BaseTypes.Action<nsACString, nsACString> func, string value1, string value2)
		{
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public static T Pass<T>(BaseTypes.Func<nsACString, T> func, string value)
		{
			return GenericPass(func, value);
		}
		...
		/// <param name="value2"></param>
		/// <returns></returns>
		public static T Pass<T>(BaseTypes.Func<nsACString, nsACString, T> func, string value1, string value2)
		{
		...
		public static string Get(BaseTypes.Action<nsAString> getter)
		{
			return GenericGet(getter);
		}

		public static string Get(BaseTypes.Action<nsAString, nsAString> getter, string inValue)
		{
			return GenericGet(getter, inValue);
		}


		public static string Get<T>(BaseTypes.Action<T, nsAString> func, T value)
		{
			return GenericGet( func, value );
		}

		public static string Get<T1,T2>(BaseTypes.Action<T1,T2,nsAString> func,T1 value1,T2 value2)
		{
		...
		/// <param name="setter"></param>
		/// <param name="value"></param>
		public static void Set(BaseTypes.Action<nsAString> setter, string value)
		{
			GenericSet( setter, value );
		}

		public static void Set(BaseTypes.Action<nsAString, nsAString> func, string value1, string value2)
		{
			GenericSet( func, value1, value2 );
		}

		public static void Set<T>(BaseTypes.Action<T, nsAString> func, T value1, string value2)
		{
			GenericSet(func, value1, value2);
		}

		public static void Set(BaseTypes.Action<nsAString,nsAString,nsAString>func, string value1, string value2,string value3)
		{
			GenericSet( func, value1, value2, value3 );
		}

		public static void Set<T1,T2>(BaseTypes.Action<T1,T2,nsAString> func,T1 value1,T2 value2, string stringValue)
		{
			GenericSet( func, value1, value2, stringValue );
		}

		public static void Set<T1, T2>(BaseTypes.Action<T1,nsACString, T2 > func, T1 value1,string stringValue, T2 value2 )
		{
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public static T Pass<T>(BaseTypes.Func<nsAString,T> func,string value)
		{
			return GenericPass(func, value);
		}
		...
		/// <param name="value2"></param>
		/// <returns></returns>
		public static T Pass<T>(BaseTypes.Func<nsAString,nsAString, T> func, string value1,string value2)
		{
			return GenericPass( func, value1, value2 );
		}
