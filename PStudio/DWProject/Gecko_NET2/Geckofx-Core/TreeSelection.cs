...
namespace Gecko
{
    public class TreeSelection
    {
        ...
        public TreeBoxObject Tree
        {
            get
            {
                return ExtensionMethods.Wrap(_treeSelection.Instance.GetTreeAttribute(),//_searchSubmission.Instance.GetPostDataAttribute(), 
                     x => new TreeBoxObject(x));
        ...
        public TreeColumn CureentColumn
        {
            get
            {
                return ExtensionMethods.Wrap(_treeSelection.Instance.GetCurrentColumnAttribute(),
                     x => new TreeColumn(x));
