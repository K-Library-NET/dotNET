...
namespace Gecko
{
        ...
        : ICloneable
    {
        ...
        public GeckoNode StartContainer
        {
            get
            {
                return ExtensionMethods.Wrap(_range.Instance.GetStartContainerAttribute(),
                     GeckoNode.Create);
        ...
        public GeckoNode EndContainer
        {
            get
            {
                return ExtensionMethods.Wrap(_range.Instance.GetEndContainerAttribute(),
                     GeckoNode.Create);
        ...
        public GeckoNode CommonAncestorContainer
        {
            get
            {
                return ExtensionMethods.Wrap(_range.Instance.GetCommonAncestorContainerAttribute(),
                     GeckoNode.Create);
        ...
        {
            return ExtensionMethods.Wrap(_range.Instance.ExtractContents(),
                 GeckoNode.Create);
        ...
        {
            return ExtensionMethods.Wrap(_range.Instance.CloneContents(),
                 GeckoNode.Create);
