...
namespace Gecko
{
	public static class GeckoElementExtensions
	{
		...
		/// <returns></returns>
		public static string GetData(GeckoHtmlElement node, string dataAttributeName)
		{
		...
		/// <returns></returns>
		public static T FindFirstChildInTree<T>(GeckoNode element, Predicate<T> predicate)
			where T:GeckoNode
		{
