...
namespace GeckofxUnitTests
{
    ...
    internal class GeckoWebBrowserTests
    {
        ...
        public void DomContentChanged_ChangeContentOfTextInputWithKeyPressAndMoveToSecondInput_DomContentChangedShouldFire()
        {
            ...
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, html);
        ...
        public void LoadFrameset_RegressionTest_ShouldNotThrowException()
        {
            ...
            GeckoWebBrowserTextExtensionMethods.TestLoadFrameset(browser, innerHtml);
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, "hello world.");
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadEditableHtml(browser, "hello world.");
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, string.Empty);
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, "hello <span>world</span>");
        ...
        public void EvaluateScript_Run500TimesNavigatingToANewDocumentEachTime_DoesNotCrash()
        {
            for (int i = 0; i < 500; i++)
            {
                GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, String.Format("{0}", i));//"hello <span>world</span>");
