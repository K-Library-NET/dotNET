...
namespace GeckofxUnitTests
{
    ...
    internal class GeckoDocumentTests
    {
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, "<div name=\"a\" id=\"_lv5\">old value</div>");
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, "<svg id=\"sss\" width=\"380\" height=\"100\"><text id=\"t1\" class=\"caption\" x=\"10\" y=\"35\">Mouseover a square</text></svg>");
        ...
        public void GetElements_XPathSelectsSingleElement_ReturnsCollectionWithSingleItem()
        {
            ...
            int count = 0;
            var enumerator = divElement.GetEnumerator();
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, "<span>hello world</span>");
        ...
        {
            GeckoWebBrowserTextExtensionMethods.TestLoadHtml(browser, "<form id=\"a\">hello world</form><form id=\"b\">hi</form>");
