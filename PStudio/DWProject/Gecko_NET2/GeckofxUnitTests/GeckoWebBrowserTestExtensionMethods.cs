...
namespace GeckofxUnitTests
{
	public static class GeckoWebBrowserTextExtensionMethods
	{
		...
		internal static void TestLoadHtml(GeckoWebBrowser browser, string innerHtml)
		{
		...
		/// </summary>
		/// <param name="innerHtml"></param>
		internal static void TestLoadEditableHtml(GeckoWebBrowser browser, string innerHtml)
		{
		...
		/// </summary>
		/// <param name="innerHtml"></param>
		internal static void TestLoadSvg(GeckoWebBrowser browser, string innerSvg)
		{
			LoadSvg(browser, innerSvg);
		}

		private static void LoadSvg(GeckoWebBrowser browser, string innerSvg)
		{
