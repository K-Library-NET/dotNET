...
namespace FlightDataReading.AircraftModel1
{
    public class AircraftModel1RawDataBuilder : FlightDataEntitiesRT.ModelRawDataBuilder
    {
        ...
        public static void AssignValueSimple(AircraftModel1RawData data,
            FlightDataEntitiesRT.ParameterRawData two, int valueIndex)
        {
            if (data != null && two != null && two.Values != null && two.Values.Count() > valueIndex)
            {
                AircraftModel1RawData dt = data;
                if (!string.IsNullOrEmpty(two.ParameterID))// && dt.Fields.Contains(two.ParameterID))
                {
                ...
                "Second", "Et","Hp","Vi","M","aT","Vy","Tt","ZH","HG","FY","EW","NS",
                     */
                    if (two.ParameterID == "Et")
                        dt.Et = two.Values[valueIndex];
                    if (two.ParameterID == "Hp")
                        dt.Hp = two.Values[valueIndex];
                    if (two.ParameterID == "Vi")
                        dt.Vi = two.Values[valueIndex];
                    if (two.ParameterID == "M")
                        dt.M = two.Values[valueIndex];
                    if (two.ParameterID == "aT")
                        dt.aT = two.Values[valueIndex];
                    if (two.ParameterID == "Vy")
                        dt.Vy = two.Values[valueIndex];
                    if (two.ParameterID == "Tt")
                        dt.Tt = two.Values[valueIndex];
                    if (two.ParameterID == "ZH")
                        dt.ZH = two.Values[valueIndex];
                    if (two.ParameterID == "HG")
                        dt.HG = two.Values[valueIndex];
                    if (two.ParameterID == "EW")
                        dt.EW = two.Values[valueIndex];
                    if (two.ParameterID == "NS")
                        dt.NS = two.Values[valueIndex];
                    //"DR","GS","Wy","Wx","Wz","KZB","KCB","ZS","CS","Ny","Nx","Nz",
                    if (two.ParameterID == "DR")
                        dt.DR = two.Values[valueIndex];
                    if (two.ParameterID == "GS")
                        dt.GS = two.Values[valueIndex];
                    if (two.ParameterID == "Wy")
                        dt.Wy = two.Values[valueIndex];
                    if (two.ParameterID == "Wx")
                        dt.Wx = two.Values[valueIndex];
                    if (two.ParameterID == "Wz")
                        dt.Wz = two.Values[valueIndex];
                    if (two.ParameterID == "KZB")
                        dt.KZB = two.Values[valueIndex];
                    if (two.ParameterID == "KCB")
                        dt.KCB = two.Values[valueIndex];
                    if (two.ParameterID == "ZS")
                        dt.ZS = two.Values[valueIndex];
                    if (two.ParameterID == "CS")
                        dt.CS = two.Values[valueIndex];
                    if (two.ParameterID == "Ny")
                        dt.Ny = two.Values[valueIndex];
                    if (two.ParameterID == "Nx")
                        dt.Nx = two.Values[valueIndex];
                    if (two.ParameterID == "Nz")
                        dt.Nz = two.Values[valueIndex];
                    //"Dy","Dx","Dz","T6L","T6R","NHL","NHR",
                    if (two.ParameterID == "Dy")
                        dt.Dy = two.Values[valueIndex];
                    if (two.ParameterID == "Dx")
                        dt.Dx = two.Values[valueIndex];
                    if (two.ParameterID == "Dz")
                        dt.Dz = two.Values[valueIndex];
                    if (two.ParameterID == "T6L")
                        dt.T6L = two.Values[valueIndex];
                    if (two.ParameterID == "T6R")
                        dt.T6R = two.Values[valueIndex];
                    if (two.ParameterID == "NHL")
                        dt.NHL = two.Values[valueIndex];
                    if (two.ParameterID == "NHR")
                        dt.NHR = two.Values[valueIndex];
                    //"KG1","KG2","KG3","KG4","KG5","KG6","KG7","KG8","KG9","KG10","KG11","KG12","KG13","KG14","KG15"
                    if (two.ParameterID == "KG1")
                        dt.KG1 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG2")
                        dt.KG2 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG3")
                        dt.KG3 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG4")
                        dt.KG4 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG5")
                        dt.KG5 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG6")
                        dt.KG6 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG7")
                        dt.KG7 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG8")
                        dt.KG8 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG9")
                        dt.KG9 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG10")
                        dt.KG10 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG11")
                        dt.KG11 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG12")
                        dt.KG12 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG13")
                        dt.KG13 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG14")
                        dt.KG14 = (int)two.Values[valueIndex];
                    if (two.ParameterID == "KG15")
                        dt.KG15 = (int)two.Values[valueIndex];
                }
            }
        }
